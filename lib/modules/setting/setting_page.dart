    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            icon: const Icon(ZPassIcons.icClose, size: 18.5, color: Color.fromRGBO(149, 155, 167, 1),),
        ),
      ),
      body: Container(
          padding: const EdgeInsets.fromLTRB(16, 5, 16, 20.5),
                  ...
                  child: Row(
                    children: [
                      ClipRRect(
                        ...
                        child: UserAvatar(url: userInfo.avatar, placeholder: userInfo.userName),
                      ),
                      Container(
