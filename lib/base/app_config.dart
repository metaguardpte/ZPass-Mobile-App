...
class AppConfig {
  ...
  static const String _serverDev = "https://ro8d3r7nxb.execute-api.ap-southeast-1.amazonaws.com/Prod";
  static const String _serverTest = "https://l8ee0j8yb8.execute-api.ap-southeast-1.amazonaws.com/Prod";
